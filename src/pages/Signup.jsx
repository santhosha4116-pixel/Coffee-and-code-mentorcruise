...
export default function Signup() {
 ...
 const navigate = useNavigate()
  ...
  function submit(e){ e.preventDefault(); const e2=validate(); setErrors(e2); if(Object.keys(e2).length===0){
    setSuccess(true); setForm({firstName:"",lastName:"",email:"",phone:""});
    navigate("/")

  } }
  const valid=Object.keys(
    validate()).length===0 && Object.values(form).every(v=>v.trim()
  );
